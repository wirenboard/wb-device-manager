...
* при остановке - сервис чистит топики
    * #### сканирование портов (*/bus-scan/Scan):
        ...
        * сформировав некорректный запрос к wb-mqtt-serial'у (например, добавив ему в конфиг несуществующий порт через webui) в процессе сканирования, должны получить ошибку "com.wb.device_manager.generic_error" в поле "error" state-топика. Проследить, что сканирование - сразу прекратилось
